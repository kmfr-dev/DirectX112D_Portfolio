    ...
    const std::string& Name)
{
    ...
    case EProgressBarImageType::Fill:
        ...
        break;
    case EProgressBarImageType::Frame:
        mFrameBrush.Texture = Texture;
        break;
    }
}
...
void CProgressBar::SetTint(EProgressBarImageType Type, float r, float g, float b)
{
    ...
    case EProgressBarImageType::Fill:
        ...
        break;
    case EProgressBarImageType::Frame:
        mFrameBrush.Tint.x = r;
        mFrameBrush.Tint.y = g;
        mFrameBrush.Tint.z = b;
        break;
    }
}
...
void CProgressBar::SetBrushAnimation(EProgressBarImageType Type, bool Animation)
{
    ...
    case EProgressBarImageType::Fill:
        ...
        break;
    case EProgressBarImageType::Frame:
        mFrameBrush.AnimationEnable = Animation;
        break;
    }
}
    ...
    const FVector2D& Size)
{
    ...
    case EProgressBarImageType::Fill:
        ...
        break;
    case EProgressBarImageType::Frame:
        mFrameBrush.Frames.emplace_back(Frame);

        mFrameBrush.FrameTime = mFrameBrush.PlayTime /
            mFrameBrush.Frames.size();
        break;
    }
}
...
void CProgressBar::Render()
{
    ...
    if (mFrameBrush.Texture)
    {
        RenderBrush(mFillBrush, Size);
        RenderBrush(mFrameBrush, mSize);
    }
    else
        RenderBrush(mFillBrush, Size);
}
...
void CProgressBar::Render(const FVector3D& Pos)
{
    ...
    if(mFrameBrush.Texture)
    {
        ...
        RenderBrush(mFrameBrush, RenderPos, mSize);
    }
    else
    {
        RenderBrush(mFillBrush, RenderPos, Size);
